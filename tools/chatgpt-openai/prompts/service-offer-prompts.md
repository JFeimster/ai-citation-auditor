...
## Purpose
Copy-paste prompts for service offer prompts in AI Citation Auditor workflows.

## When to use it
- Use when you need a reusable prompt for single-page audit offers, five-page refresh offers, internal-link sprint offers, schema audit offers, risk rewrite packages, AI-search optimization sprints, proposal generation, and scope boundary language.
...
### Prompt 1
```text
Audit the following service offer for single-page audit offers, five-page refresh offers, internal-link sprint offers, schema audit offers, risk rewrite packages, AI-search optimization sprints, proposal generation, and scope boundary language. Return a table with issue, severity, evidence, fix, and next step. Do not guarantee rankings, citations, funding, approvals, or financial outcomes.
```

### Prompt 2
```text
Rewrite only the risky or unclear parts of the service offer. Preserve intent, keep the copy useful, and remove absolute or unsupported claims.
```

### Prompt 3
```text
Break the task into sections and evaluate each section separately for single-page audit offers, five-page refresh offers, internal-link sprint offers, schema audit offers, risk rewrite packages, AI-search optimization sprints, proposal generation, and scope boundary language. Quote the exact line or heading that needs attention.
```

### Prompt 4
```text
Create a concise checklist for single-page audit offers, five-page refresh offers, internal-link sprint offers, schema audit offers, risk rewrite packages, AI-search optimization sprints, proposal generation, and scope boundary language that an operator can run before publishing or shipping.
```

### Prompt 5
```text
Return a structured summary for service offer with what is working, what is weak, what is risky, and what should happen next.
```
