# Blog Rewrite Prompts

## Purpose
Copy-paste prompts for blog rewrite prompts in AI Citation Auditor workflows.

## When to use it
- Use when you need a reusable prompt for rewriting intros into direct answers, adding answer blocks, comparison tables, FAQ sections, internal links, risk disclaimers, better headings, and who-this-is-for sections.
...
### Prompt 1
```text
Audit the following blog rewrite for rewriting intros into direct answers, adding answer blocks, comparison tables, FAQ sections, internal links, risk disclaimers, better headings, and who-this-is-for sections. Return a table with issue, severity, evidence, fix, and next step. Do not guarantee rankings, citations, funding, approvals, or financial outcomes.
```

### Prompt 2
```text
Rewrite only the risky or unclear parts of the blog rewrite. Preserve intent, keep the copy useful, and remove absolute or unsupported claims.
```

### Prompt 3
```text
Break the task into sections and evaluate each section separately for rewriting intros into direct answers, adding answer blocks, comparison tables, FAQ sections, internal links, risk disclaimers, better headings, and who-this-is-for sections. Quote the exact line or heading that needs attention.
```

### Prompt 4
```text
Create a concise checklist for rewriting intros into direct answers, adding answer blocks, comparison tables, FAQ sections, internal links, risk disclaimers, better headings, and who-this-is-for sections that an operator can run before publishing or shipping.
```

### Prompt 5
```text
Return a structured summary for blog rewrite with what is working, what is weak, what is risky, and what should happen next.
```
