# Answer Engine Optimization Prompts

## Purpose
Copy-paste prompts for answer engine optimization prompts in AI Citation Auditor workflows.

## When to use it
- Use when you need a reusable prompt for direct-answer blocks, entity clarity, source context, snippet-ready paragraph rewrites, FAQ extraction, comparison table generation, and claim safety.
...
### Prompt 1
```text
Audit the following answer engine optimization for direct-answer blocks, entity clarity, source context, snippet-ready paragraph rewrites, FAQ extraction, comparison table generation, and claim safety. Return a table with issue, severity, evidence, fix, and next step. Do not guarantee rankings, citations, funding, approvals, or financial outcomes.
```

### Prompt 2
```text
Rewrite only the risky or unclear parts of the answer engine optimization. Preserve intent, keep the copy useful, and remove absolute or unsupported claims.
```

### Prompt 3
```text
Break the task into sections and evaluate each section separately for direct-answer blocks, entity clarity, source context, snippet-ready paragraph rewrites, FAQ extraction, comparison table generation, and claim safety. Quote the exact line or heading that needs attention.
```

### Prompt 4
```text
Create a concise checklist for direct-answer blocks, entity clarity, source context, snippet-ready paragraph rewrites, FAQ extraction, comparison table generation, and claim safety that an operator can run before publishing or shipping.
```

### Prompt 5
```text
Return a structured summary for answer engine optimization with what is working, what is weak, what is risky, and what should happen next.
```
