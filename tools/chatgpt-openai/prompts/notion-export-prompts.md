# Notion Export Prompts

## Purpose
Copy-paste prompts for notion export prompts in AI Citation Auditor workflows.

## When to use it
- Use when you need a reusable prompt for Funding Partners exports, Custom GPT exports, tool database exports, blog exports, vendor directory exports, offer catalog exports, and prompt library exports.
...
### Prompt 1
```text
Audit the following notion export for Funding Partners exports, Custom GPT exports, tool database exports, blog exports, vendor directory exports, offer catalog exports, and prompt library exports. Return a table with issue, severity, evidence, fix, and next step. Do not guarantee rankings, citations, funding, approvals, or financial outcomes.
```

### Prompt 2
```text
Rewrite only the risky or unclear parts of the notion export. Preserve intent, keep the copy useful, and remove absolute or unsupported claims.
```

### Prompt 3
```text
Break the task into sections and evaluate each section separately for Funding Partners exports, Custom GPT exports, tool database exports, blog exports, vendor directory exports, offer catalog exports, and prompt library exports. Quote the exact line or heading that needs attention.
```

### Prompt 4
```text
Create a concise checklist for Funding Partners exports, Custom GPT exports, tool database exports, blog exports, vendor directory exports, offer catalog exports, and prompt library exports that an operator can run before publishing or shipping.
```

### Prompt 5
```text
Return a structured summary for notion export with what is working, what is weak, what is risky, and what should happen next.
```
