...
## Purpose
Copy-paste prompts for content audit prompts in AI Citation Auditor workflows.

## When to use it
- Use when you need a reusable prompt for answer clarity, extraction structure, schema fit, internal links, trust signals, risky claims, and pre-publish review.
...
### Prompt 1
```text
Audit the following content audit for answer clarity, extraction structure, schema fit, internal links, trust signals, risky claims, and pre-publish review. Return a table with issue, severity, evidence, fix, and next step. Do not guarantee rankings, citations, funding, approvals, or financial outcomes.
```

### Prompt 2
```text
Rewrite only the risky or unclear parts of the content audit. Preserve intent, keep the copy useful, and remove absolute or unsupported claims.
```

### Prompt 3
```text
Break the task into sections and evaluate each section separately for answer clarity, extraction structure, schema fit, internal links, trust signals, risky claims, and pre-publish review. Quote the exact line or heading that needs attention.
```

### Prompt 4
```text
Create a concise checklist for answer clarity, extraction structure, schema fit, internal links, trust signals, risky claims, and pre-publish review that an operator can run before publishing or shipping.
```

### Prompt 5
```text
Return a structured summary for content audit with what is working, what is weak, what is risky, and what should happen next.
```
