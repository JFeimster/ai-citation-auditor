...
## Purpose
Planning guidance for connecting search queries, page performance, and refresh priorities to the registry architecture and workflow docs.

## When to use
- Use when mapping search queries, page performance, and refresh priorities.
...
## Potential outputs
- /registries/generated/search-queries.json
- /registries/generated/page-performance.json
- /registries/generated/refresh-priorities.json
