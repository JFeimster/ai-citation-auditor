...
## Purpose
Planning guidance for connecting payment links, checkout maps, and refund policy maps to the registry architecture and workflow docs.

## When to use
- Use when mapping payment links, checkout maps, and refund policy maps.
...
## Potential outputs
- /registries/generated/payment-links.json
- /registries/generated/offer-checkout-map.json
- /registries/generated/refund-policy-map.json
