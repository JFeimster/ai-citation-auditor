# Notion Custom GPTs Integration

## Purpose
Planning guidance for connecting My Custom GPTs database, GPT actions map, GPT knowledge manifest, and GPT categories to the registry architecture and workflow docs.

## When to use
- Use when mapping My Custom GPTs database, GPT actions map, GPT knowledge manifest, and GPT categories.
...
## Potential outputs
- /registries/generated/custom-gpts.json
- /registries/generated/gpt-actions-map.json
- /registries/generated/gpt-knowledge-manifest.json
- /registries/generated/gpt-categories.json
- /registries/generated/gpt-build-status.json
