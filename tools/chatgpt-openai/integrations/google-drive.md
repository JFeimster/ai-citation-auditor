...
## Purpose
Planning guidance for connecting knowledge source files, upload manifests, and source docs to the registry architecture and workflow docs.

## When to use
- Use when mapping knowledge source files, upload manifests, and source docs.
...
## Potential outputs
- /registries/generated/knowledge-source-files.json
- /registries/generated/upload-manifest.json
- /registries/generated/source-docs.json
