...
## Purpose
Planning guidance for connecting lead stages, contact properties, service inquiry routing, and follow-up sequences to the registry architecture and workflow docs.

## When to use
- Use when mapping lead stages, contact properties, service inquiry routing, and follow-up sequences.
...
## Potential outputs
- /registries/generated/lead-stages.json
- /registries/generated/contact-properties.json
- /registries/generated/service-inquiry-routing.json
- /registries/generated/follow-up-sequences.json
