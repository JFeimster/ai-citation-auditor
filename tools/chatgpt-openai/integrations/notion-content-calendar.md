...
## Purpose
Planning guidance for connecting content calendar, article briefs, and content status to the registry architecture and workflow docs.

## When to use
- Use when mapping content calendar, article briefs, and content status.
...
## Potential outputs
- /registries/generated/content-calendar.json
- /registries/generated/article-briefs.json
- /registries/generated/content-status.json
