...
## Purpose
Planning guidance for connecting Funding Partners database, My Custom GPTs database, and knowledge manifest sources to the registry architecture and workflow docs.

## When to use
- Use when mapping Funding Partners database, My Custom GPTs database, and knowledge manifest sources.
