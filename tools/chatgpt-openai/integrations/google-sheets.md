...
## Purpose
Planning guidance for connecting operational tables, lead routing, CTA registries, and content inventories to the registry architecture and workflow docs.

## When to use
- Use when mapping operational tables, lead routing, CTA registries, and content inventories.
...
## Potential outputs
- /registries/manual/vendor-directory.json
- /registries/manual/cta-library.json
