# GitHub Repo Files Integration

## Purpose
Planning guidance for connecting repository markdown files, action schemas, site pages, and assets to the registry architecture and workflow docs.

## When to use
- Use when mapping repository markdown files, action schemas, site pages, and assets.
...
## Potential outputs
- /registries/generated/site-pages.json
- /registries/generated/docs-index.json
- /registries/generated/tools-index.json
- /registries/generated/assets-index.json
